...
interface DeckingContactFormProps {
  location?: { name: string; regionLabel?: string };
}

export const DeckingContactForm = ({ location }: DeckingContactFormProps) => {
  return (
      ...
      <div className="relative z-10 box-border caret-transparent max-w-[1204px] mx-auto px-4 sm:px-5 md:px-8">
        <div className="box-border caret-transparent text-center mb-12 md:mb-16">
          ...
          <p className="text-lg md:text-xl text-white/90 box-border caret-transparent max-w-3xl mx-auto">
            {location
              ? `Fill out the form below and we'll get back to you as soon as possible to discuss your decking project in ${location.name}. Serving ${location.name}, ${location.regionLabel || "Scotland"} and surrounding areas. Free quotes available.`
              : "Fill out the form below and we'll get back to you as soon as possible to discuss your decking project. Serving all of Scotland. Free quotes available for all deck installations."}
          </p>
        </div>
