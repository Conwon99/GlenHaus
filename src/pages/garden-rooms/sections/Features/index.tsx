export const GardenRoomsFeatures = () => {
  const features = [
    {
      icon: (
      ...
      title: "Custom Design",
      description: "Every garden room is tailored to your specific needs and garden space. From home offices to relaxation spaces, we create the perfect solution for you."
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: "We use only the finest materials to ensure your garden room stands the test of time. Built to last with weather-resistant construction."
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: "Professional installation by our experienced team. Most garden rooms are completed within a few days, with minimal disruption to your garden."
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      title: "Scotland Wide",
      description: "Serving all of Scotland including Ayrshire, Glasgow, Edinburgh, and surrounding areas. Professional service you can trust."
    }
  ];

  return (
    <section className="box-border caret-transparent pt-[70px] pb-[50px] md:pt-[140px] md:pb-[70px] bg-white">
        ...
        <div className="box-border caret-transparent gap-x-[30px] grid auto-cols-[1fr] grid-cols-[1fr] grid-rows-[auto] gap-y-[30px] md:gap-x-[70px] md:grid-cols-[1fr_1fr] md:gap-y-[70px]">
          ...
          <div className="box-border caret-transparent gap-x-[30px] flex flex-col justify-between gap-y-[30px] md:gap-x-[50px] md:gap-y-[50px]">
            <div className="box-border caret-transparent">
              <div className="box-border caret-transparent flex justify-center md:justify-start mb-6">
                <img
                  src="/logo-garden-rooms.png"
                  alt="Glenhaus Garden Rooms Logo"
                  className="max-w-[200px] md:max-w-[250px] h-auto box-border caret-transparent"
                />
              </div>
              ...
              <p className="text-gray-700 text-sm sm:text-base box-border caret-transparent mt-2.5 mb-5 md:mt-5 md:mb-5 leading-relaxed">
                Professional installation, quality materials, and expert craftsmanship - everything you need for your perfect garden room.
              </p>
